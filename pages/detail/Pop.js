...
export default function Pop() {
  ...
  const getSofaDetail = async () => {
    try {
      const data = await api.detail.getSofaDetail(171);
  ...
  const getFabricDetail = async () => {
    try {
      const data = await api.detail.getFabricDetail(373);
  ...
  return (
    <>
      <HeadMeta
        title={'東璟家具 - 沙發 - Pop'}
        description={
          '太常把自身裝進太庸俗的真實世界，不如就成為變形蟲吧，好好回到靈感的原點，繼續複製。'
        }
        keywords={'家具,精品沙發,沙發,波普藝術,pop'}
      />
      {detailData && (
                ...
                <ul className="item-area">
                  ...
                  <li className="item-list">
                    ...
                    <span className="item-content">
                      ...
                      <p>{detailData.tab1.remark.remark3}</p>
                    </span>
                  </li>
                  <li className="item-list">
                ...
                <ul className="item-area">
                  ...
                  <li className="item-list">
                    ...
                    <span className="item-content">
                      ...
                      <p>{detailData.tab2.remark.remark3}</p>
                    </span>
                  </li>
                  <li className="item-list">
                    <p className="item-title">面料</p>
