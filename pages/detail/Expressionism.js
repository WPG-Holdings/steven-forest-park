...
export default function Expressionism() {
  ...
  const getSofaDetail = async () => {
    try {
      const data = await api.detail.getSofaDetail(60);
  ...
  const getFabricDetail = async () => {
    try {
      const data = await api.detail.getFabricDetail(369);
  ...
  return (
    <>
      <HeadMeta
        title={'東璟家具 - 沙發 - Expressionism'}
        description={
          '突破和解放必須從既定規則中迸現，思想如是，身體亦如是。為了風格，我總是願意多悖離常理一點點。'
        }
        keywords={'家具,精品沙發,沙發,表現派,expressionism'}
      />
      {detailData && (
        <div className="page-expressionism">
                ...
                <ul className="item-area">
                  ...
                  <li className="item-list">
                    ...
                    <span className="item-content">
                      ...
                      <p>{detailData.tab1.size.size4}</p>
                    </span>
                  </li>
                  <li className="item-list">
                ...
                <ul className="item-area">
                  <li className="item-list">
                    ...
                    <span className="item-content">
                      ...
                      <p>{detailData.tab2.price.price3}</p>
                      <p style={{ paddingTop: '8px' }}>
                  ...
                  <li className="item-list">
                    ...
                    <span className="item-content">
                      ...
                      <p>{detailData.tab2.size.size4}</p>
                    </span>
                  </li>
                  <li className="item-list">
                    <p className="item-title">材質</p>
                ...
                <ul className="item-area">
                  <li className="item-list">
                    ...
                    <span className="item-content">
                      ...
                      <p>{detailData.tab3.price.price3}</p>
                      <p style={{ paddingTop: '8px' }}>
